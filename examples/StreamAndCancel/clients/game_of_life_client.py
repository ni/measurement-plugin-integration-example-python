"""Generated client API for the "Conway's Game of Life (Py)" measurement plug-in."""
...
class Outputs(typing.NamedTuple):
    """Outputs for the "Conway's Game of Life (Py)" measurement plug-in."""

    game_of_life: DoubleXYData
    generation: int


class GameOfLifeClient:
    """Client for the "Conway's Game of Life (Py)" measurement plug-in."""
    ...
    def __init__(
        ...
        *,
        ...
        self._service_class = "ni.examples.GameOfLife_Python"
        self._version = "1.0.0"
        ...
        self._configuration_metadata = {
            ...
            3: ParameterMetadata(
                display_name="update_interval_msec",
                type=Field.Kind.ValueType(13),
                repeated=False,
                default_value=100,
                annotations={},
                message_type="",
                field_name="update_interval_msec",
                enum_type=None,
            ),
            4: ParameterMetadata(
                display_name="max_generations",
                type=Field.Kind.ValueType(5),
                repeated=False,
                default_value=-1,
                annotations={},
                message_type="",
                field_name="max_generations",
                enum_type=None,
            ),
        }
        self._output_metadata = {
            1: ParameterMetadata(
                display_name="game_of_life",
                type=Field.Kind.ValueType(11),
                repeated=False,
                default_value=None,
                annotations={},
                message_type="ni.protobuf.types.DoubleXYData",
                field_name="game_of_life",
                enum_type=None,
            ),
            2: ParameterMetadata(
    ...
    def measure(
        ...
        stream_measure_response = self.stream_measure(
            width, height, update_interval_msec, max_generations
        )
    ...
    def stream_measure(
        ...
        """
        parameter_values = [width, height, update_interval_msec, max_generations]
        with self._initialization_lock:
