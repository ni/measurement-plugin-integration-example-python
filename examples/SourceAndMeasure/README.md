...
- Ensure that you have the `ni-measurement-plugin-sdk-service` and the basic logger package `ni-sequence-logger`*(download from the latest release assets)* installed in your machine or virtual environment.
