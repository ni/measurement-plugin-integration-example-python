"""Generated client API for the 'Sample Measurement (Py)' measurement plug-in."""
...
class Outputs(typing.NamedTuple):
    """Outputs for the 'Sample Measurement (Py)' measurement plug-in."""
...
class SampleMeasurement_Python:
    """Client for the 'Sample Measurement (Py)' measurement plug-in."""
    ...
    def measure(
        ...
        string_array_in: typing.Iterable[str] = ["String1", "String2"],
    ) -> Outputs:
